...
void VulkanRenderer::recordCommands(uint32_t currentImage)
{
	...
	clearValues[0].color = { 0.6f, 0.65f, 0.4f, 1.0f };				// Clear values for attachment 1 (colour)
	clearValues[1].depthStencil.depth = 1.0f;						// Clear values for attachment 2 (depth)
