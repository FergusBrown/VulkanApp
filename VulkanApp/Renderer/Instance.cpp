	...
	std::vector<const char*>& requiredInstanceExtensions)
{
	...
	appInfo.pEngineName = "weewoo";							// Custom engine name
	...
	createInfo.enabledExtensionCount = static_cast<uint32_t>(requiredInstanceExtensions.size());	// Cast to uint32_t as size returns a type t
