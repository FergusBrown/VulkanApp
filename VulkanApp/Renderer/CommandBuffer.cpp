...
// Call draw command which will draw a fullscreen triangle when the fullscreen vertex shader is used
void CommandBuffer::drawFullscreen()
{
	vkCmdDraw(mHandle, 3, 1, 0, 0);
}
