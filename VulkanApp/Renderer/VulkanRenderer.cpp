...
//void VulkanRenderer::createRenderTargetAndFrames()
//{
...
void VulkanRenderer::getRequiredExtenstionAndFeatures(std::vector<const char*>& requiredExtensions, VkPhysicalDeviceFeatures& requiredFeatures)
{
	requiredExtensions = {
